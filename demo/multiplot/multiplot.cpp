...
int main( void )
{
   ...
   try
   {
      ...
      plot << "set grid" << endl;
      plot << "set multiplot layout 2, 1 title \"Multiplot layout 2, 1\" font \",14\"" << endl;

      plot << "set title \"Plot 1\"" << endl;
      plot << "plot '-' title \"\" with lines" << endl;
      for( int i = 0; i <= 100; i++ )
         plot << i << ' ' << i << endl;
      plot << 'e' << endl;

      plot << "set title \"Plot 2\"" << "font \",14\"" << endl;
      plot << "plot '-' title \"Test 2\" with lines" << endl;
      for( int i = 0; i <= 100; i++ )
         plot << 100-i << ' ' << i << endl;
      plot << 'e' << endl;
